function [mix, options, errlog] = gmmem_imputation(mix, xo, options)
%GMMEM_IMPUTATION	EM algorithm for Gaussian mixture model imputation. This is a
%modification of the gmmem function by Ian T Nabney.
%
%	Description
...
for n = 1:niters
  ...
  % Imputation of missing values based on the current model  
